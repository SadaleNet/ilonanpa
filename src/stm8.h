// Adapted from https://github.com/jukkas/stm8-sdcc-examples/blob/master/stm8.h
/*
...
#define FLASH_PUKR_KEY_1 0x56
#define FLASH_PUKR_KEY_2 0xAE

#define FLASH_DUKR_KEY_1 0xAE
#define FLASH_DUKR_KEY_2 0x56
